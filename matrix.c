...
/* Menghitung nilai determinan m */
    ...
    if (n == 1) {
        ...
        while (x < n && det == 0) {
            ...
            if (det == 0) {
                det += sign * ELMT(m, 0, x) * determinant(m3);
                sign = -sign;
            }
            x++;
        }
