...
void ganti_profil() {
  ...
  STARTWORD();
  LowerCase();
  while ((!compareWordwString(currentWord, "pahing")) &&
         (!compareWordwString(currentWord, "kliwon")) &&
         (!compareWordwString(currentWord, "wage")) &&
         (!compareWordwString(currentWord, "pon")) &&
         (!compareWordwString(currentWord, "legi"))) {
...
void lihat_profil(Word Username) {
  ...
  if (i != IDX_UNDEF) {
    ...
    printf("Wah, akun dengan nama ");
    printWord(Username);
    printf(" tidak ditemukan. Coba lagi, yuk!\n");
  }
}
...
void atur_jenis_akun() {
  ...
  if (currentUser.public)
    printf("Publik. Ingin mengubah ke akun Privat? (YA/TIDAK)\n");
  else
    printf("Privat. Ingin mengubah ke akun Publik? (YA/TIDAK)\n");

  STARTWORD();
  while (!compareWordwString(currentWord, "YA") &&
         !compareWordwString(currentWord, "TIDAK")) {
